function plot_arm(q, v)
    ...
    %figure(1)
    plot3(joint_points(:,1),joint_points(:,2),joint_points(:,3),'-o','MarkerSize',10, 'LineWidth',2);
    hold on
    quiv = quiver3(joint_points(4,1),joint_points(4,2),joint_points(4,3), v(1), v(2), v(3));
